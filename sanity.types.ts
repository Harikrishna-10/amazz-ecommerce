...
export type Order = {
  ...
  _rev: string;
  orderNumber?: string;
  stringCheckoutSessionId?: string;
...
export type AllSanitySchemaTypes = Sale | Category | BlockContent | Order | Post | Author | ProductType | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type==\"productType\"] | order(name.asc)": ALL_PRODUCTS_QUERYResult;
